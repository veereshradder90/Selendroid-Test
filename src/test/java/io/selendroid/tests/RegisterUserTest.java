...
public class RegisterUserTest extends BaseTest {
	...
	public void registerUserTest(String userName, String emailId, String passWord, String name)
	...
	public Object[][] excelDP() throws IOException {
		...
		Object[][] arrObj = methods.getExcelData(
				GenericMethods.readDataFromPropertiesFile("fileName", Android_Property_FilePath),
				GenericMethods.readDataFromPropertiesFile("sheetName", Android_Property_FilePath));
		return arrObj;
	}
